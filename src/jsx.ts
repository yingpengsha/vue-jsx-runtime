import { createVNode, isVNode, resolveDirective, toDisplayString, vModelCheckbox, vModelDynamic, vModelRadio, vModelSelect, vModelText, vShow, withDirectives } from 'vue'
import type { DirectiveArguments, VNodeTypes } from 'vue'
...
function baseGetSet (object: object, paths: string[], set?: any) {
  ...
  return (index && (index.toString() === length.toString())) ? val : undefined
}
